        ...
        <div class="row">
            ...
            <div class="col-12 mt-5">
                <p class="lead text-center text-white mb-4">
                    Nos resources disponibles
                </p>
                <div class="text-center" style="display:inline-list-item">
                    <ul style="display:inline-list-item">
                        <li><a href="#" class="card col-3 p-4 hover:primary">
                        ...
                        <li>
                            <a href="#" class="card p-4 col-3 hover:primary">
                    ...
                    <a href="#" class="card p-4 col-3 hover:primary">
                        <i class="ti-mobile font-size-34 text-primary"></i>
                        <h6 class="mt-2">
                            App Development
                        </h6>
                    </a>
                    <a href="#" class="card p-4  col-3 hover:primary">
                        <i class="ti-pie-chart font-size-34 text-primary"></i>
                        <h6 class="mt-2">
                            Data Science
                        </h6>
                    </a>
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-4 mt-4">
                <a href="#" class="card rounded overflow-hidden hover:parent">
                    <img class="hover:zoomin" src="assets/img/360x220/6.jpg" alt="">
                    <div class="card-img-overlay flex-center bg-primary-0_7 text-white text-center">
                        <p class="mb-1">
                            Browse our
                        </p>
                        <h6>
            ...
            <div class="col-md-4 mt-4">
                <a href="#" class="card rounded overflow-hidden hover:parent">
                    <img class="hover:zoomin" src="assets/img/360x220/5.jpg" alt="">
                    <div class="card-img-overlay flex-center bg-info-0_7 text-white text-center">
                        <p class="mb-1">
                            Browse our
                        </p>
                        <h6>
            ...
            <div class="col-md-4 mt-4">
                <a href="#" class="card rounded overflow-hidden hover:parent">
                    <img class="hover:zoomin" src="assets/img/360x220/4.jpg" alt="">
                    <div class="card-img-overlay flex-center bg-success-0_7 text-white text-center">
                        <p class="mb-1">
                            Browse our
                        </p>
                        <h6>
                ...
                >
                    ...
                    <div class="card text-gray height-100p shadow-v1">
                        <div class="position-relative">
                            ...
                            <div class="position-absolute d-flex align-items-center justify-content-between width-100p top-0 padding-15">
                                <span class="badge badge-primary mr-3">Featured</span>
                                <div class="group">
                                    <a href="#" class="iconbox iconbox-sm ml-1 bg-white-0_8 hover:bg-primary">
                                        <i class="ti-share"></i>
                                    </a>
                                    <a href="#" class="iconbox iconbox-sm ml-1 bg-white-0_8 hover:bg-primary">
                                        <i class="ti-heart"></i>
...
<section class="padding-y-100 bg-cover" data-dark-overlay="7" style="background: url(assets/img/1920/550_2.jpg) no-repeat;">
    <div class="container">
        <div class="row align-items-center">
            <div class="col-lg-5 mr-auto text-white my-3">
                <h2 class="line-height-normal">
                    Trusted by Over <span class="text-primary">25000+</span> Students & Organization Around the World!
                </h2>
            ...
            <div class="col-lg-8 mx-auto text-center">
                <div class="owl-carousel" data-items-tablet="1" data-items="1" data-dots="true" data-autoplay="false">
                    <div class="item">
                        ...
                        <p class="lead mt-4">
                            I've been out of college for about two years, Educati has changed my outlook on my career. Taking the foundational courses in marketing has helped me launch my career.
                        </p>
                    </div>
                    <div class="item">
                        <img class="iconbox iconbox-xxl mx-auto" src="assets/img/avatar/7.jpg" alt="">
                        <h4 class="font-primary mt-4">
                            Alex
                        </h4>
                        <p>
...
<section class="padding-y-100 jarallax" style="background: url(assets/img/1920/500.jpg) no-repeat">
    <div class="container">
        <div class="row">
            <div class="col-lg-6 mx-auto text-center text-white">
                ...
                <a href="#" class="btn btn-white">Start Teaching</a>
            </div>
        </div>
    </div>
</section>
