                    ...
                    <div class="title_right">
                        <div class="col-md-5 col-sm-5 col-xs-12 form-group pull-right top_search">
                            <div class="input-group">
                                <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#model-add-role">Ajouter une resource</button>
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="x_panel">
                            <div class="x_content">
                                <table id="datatable-buttons" class="table table-striped table-bordered">
                                    <thead>
                                    <tr>
                                        <th>Designation de la resource</th>
                                        <th>Type</th>
                                        <th>Etat</th>
                                        <th>Chercheur ajoutant</th>
                                        <th>Details</th>
                                    </tr>
                                    </thead>
                                    <tbody>
                                    <c:forEach var="resource" items="${resources}">
                                        <tr>
                                            <td>${resource.getNom()}</td>
                                            <td>${resource.getType().getNomType()}</td>
                                            <td>${resource.getEtat()}</td>
                                            <td>${resource.getUser().getName()}</td>
                                            <td><button class="btn btn-primary" data-toggle="modal" data-target="#model-details-role-${resource.getId()}">Details</button></td>
                                        </tr>
                                    </c:forEach>
                                    </tbody>
                                </table>
